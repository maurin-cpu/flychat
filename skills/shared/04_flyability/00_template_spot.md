...

{
  ...
  "flyability_limits": ["max 3, Format: 'Kategorie: Kerninfo, Zeitbezug'. NUR Flugqualitaets-Issues (Thermik-Qualitaet, Basis, Bewoelkung, Inversion, Soaring-Wind, kurzes Fenster). KEINE Wiederholungen aus `caution_notes`/`no_go_reasons` (Boeen, Hoehenwind, Foehn, CAPE, Regen, Wind-Richtung)."],
