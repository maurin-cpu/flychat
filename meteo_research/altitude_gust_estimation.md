...
Flychat zeigt aktuell nur Bodenböen (`wind_gusts_10m`) — in der Höhe nur mittleren Wind.
...
## 4. Methodenvergleich für Flychat
...
| Methode | Stärke | Schwäche | Für Flychat |
|---------|--------|----------|-------------|
