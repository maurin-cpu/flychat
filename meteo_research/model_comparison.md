...
Diese Forschungsarbeit analysiert, welche Wettermodelle in der Gleitschirmfliegerei (insbesondere für Thermik- und Streckenflugprognosen) als Standard gelten, wie sich Modelle wie ICON-D2, ICON-CH1 und AROME unterscheiden und was die beste Wahl für das *Wingcast*-Projekt ist.
...
## 3. Schlussfolgerungen und Empfehlung für Wingcast

Aktuell nutzt *Wingcast* das `meteoswiss_icon_ch1` via Open-Meteo. 
...
Wir sollten die Kern-Wetterdatenbeschaffung in Wingcast auf **ICON-D2** umstellen.

**Begründung:** 
Das Ziel von Wingcast ist es, dem Piloten verlässliche Aussagen über Thermik, Wolken und grundsätzliche Fliegbarkeit zu geben. Das ICON-D2 Modell ist dafür erwiesenermaßen der "Sweet Spot" aus hoher Auflösung (2.2 km) und physikalischer Stabilität (weniger "Fehlalarme" bei Restbewölkung). Open-Meteo bietet `icon_d2` als vollwertige API-Alternative an. 
