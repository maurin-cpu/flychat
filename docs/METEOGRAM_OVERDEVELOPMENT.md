# Plan: Überentwicklungsgefahr (CAPE) im Meteogramm sichtbar machen

**Status:** Code umgesetzt, visuelle Abnahme + Folge-Entscheidung offen.
**Erstellt:** 2026-05-29
**Branch:** `main` (Single-Branch-Workflow)
**Betroffene Datei:** `static/js/meteogram.js`
**Wiederaufnahme:** Diese Datei lesen, dann mit Phase 2 (visuelle Abnahme) starten.
