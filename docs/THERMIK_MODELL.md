# Thermik-Modell: Wie Flychat die Thermik berechnet

## Was berechnen wir?

Flychat schätzt für jeden Flugspot stündlich drei Werte:
...
- **Regen / sehr feuchte Tage:** Niederschlag und Feuchte wirken im ICON über weniger Sonne,
  latenten Fluss und Grenzschicht. Flychat fügt **kein** separates „Regen-Veto“ auf H hinzu.
...
Alle Vorhersage-Zeitstempel in Flychat sind **Lokalzeit für die Schweiz**:
...
| **Flychat** | Hybrid: Parcel + Encroachment + GFS-Cap | Triple-Constraint + Deardorff w* |
